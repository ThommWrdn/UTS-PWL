            ...
            <div class="card-body p-4">
                <form action="{{ route('category.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control form-control-lg @error('name') is-invalid @enderror" id="name" name="name" required value="{{ old('name') }}" placeholder="Masukkan nama kategori (ex: Pakaian, Elektronik)">
                        @error('name')
